<script lang="ts">
	...
	// 	constraints: addItemConstraints,
...
<button
	...
	class="primary-btn bold-9 cursor-pointer">Add Item</button
>

{#if showModal}
	<span>
		<div class="add-item " transition:blur>
			<h3 class="white ">Add</h3>
			<button
				class="close-btn"
				on:click={() => {
					showModal = false;
			...
			<form action="">
				...
				<input type="number" name="number" placeholder="Points Needed">
